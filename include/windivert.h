...
#define WINDIVERT_DATA_NETWORK(addr)    ((addr)->Network)
#define WINDIVERT_DATA_FLOW(addr)       ((addr)->Flow)
#define WINDIVERT_DATA_SOCKET(addr)     ((addr)->Socket)
#define WINDIVERT_DATA_REFLECT(addr)    ((addr)->Reflect)

/****************************************************************************/
/* WINDIVERT HELPER MACROS                                                  */
/****************************************************************************/
...
WINDIVERTEXPORT void WinDivertHelperNtohIPv6Address(
    __in        const UINT32 *inAddr,
    __out       UINT32 *outAddr);
